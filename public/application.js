...
/***/ (function(module, exports, __webpack_require__) {
	...
	var playerEvents = __webpack_require__(37);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://hidden-cliffs-39330.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var playerUi = __webpack_require__(14);
	...
	var createNewPlayerOrShowAllPlayersText = 'Please Create a New Favorite Sports Player or Show All Your Favorite Players!';
	...
	var signInSuccess = function signInSuccess(ajaxResponse) {
	  ...
	  // Don't need to use data object here!
	  playerApi.indexPlayer().then(playerUi.checkForAnyPlayerSuccess).catch(playerUi.checkForAnyPlayerFailure);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var indexPlayer = function indexPlayer() {
	...
	var showMorePlayer = function showMorePlayer(data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showMyFavoritePlayersTemplate = __webpack_require__(15);
	var showMoreMyFavoritePlayerTemplate = __webpack_require__(36);
	var createNewPlayerOrShowAllPlayersText = 'Please Create a New Favorite Sports Player or Show All Your Favorite Players!';
	var createNewPlayerText = 'Please Create a New Favorite Sports Player!';

	var createPlayerSuccess = function createPlayerSuccess(ajaxResponse) {
	  ...
	  // Don't need to use data object here!
	  api.indexPlayer().then(indexPlayerSuccess).catch(indexPlayerFailure);
	};
	...
	var indexPlayerSuccess = function indexPlayerSuccess(ajaxResponse) {
	  ...
	  var showMyFavoritePlayersHtml = showMyFavoritePlayersTemplate({ favorite_players: ajaxResponse.favorite_players });
	  $('.content').append(showMyFavoritePlayersHtml);
	};

	var indexPlayerFailure = function indexPlayerFailure(error) {
	...
	var checkForAnyPlayerSuccess = function checkForAnyPlayerSuccess(ajaxResponse) {
	...
	var checkForAnyPlayerFailure = function checkForAnyPlayerFailure(error) {
	  // console.log('player/ui.js (indexPlayerFailure) - Error is :', error)
	  console.error(error);
	...
	var showMorePlayerSuccess = function showMorePlayerSuccess(ajaxResponse) {
	  ...
	  //  for current user
	  var showMoreMyFavoritePlayerHtml = showMoreMyFavoritePlayerTemplate({ favorite_player: ajaxResponse.favorite_player });
	  $('.content').append(showMoreMyFavoritePlayerHtml);
	};

	var showMorePlayerFailure = function showMorePlayerFailure(error) {
	...
	var removePlayerSuccess = function removePlayerSuccess() {
	  ...
	  // Don't need to use data object here!
	  api.indexPlayer().then(checkForAnyPlayerSuccess).catch(checkForAnyPlayerFailure);
	};

	var removePlayerFailure = function removePlayerFailure(error) {
	...
	module.exports = {
	  ...
	  indexPlayerSuccess: indexPlayerSuccess,
	  indexPlayerFailure: indexPlayerFailure,
	  checkForAnyPlayerSuccess: checkForAnyPlayerSuccess,
	  checkForAnyPlayerFailure: checkForAnyPlayerFailure,
	  showMorePlayerSuccess: showMorePlayerSuccess,
	  showMorePlayerFailure: showMorePlayerFailure,
	  updatePlayerSuccess: updatePlayerSuccess,
	  updatePlayerFailure: updatePlayerFailure,
	  removePlayerSuccess: removePlayerSuccess,
	  removePlayerFailure: removePlayerFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- "
	    + ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " -->\n\n  <h2><small>Player: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.player_name : stack1), depth0))
	    + "</small></h2>\n\n  <ul><data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n    <li><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"show-more-button jeter-test\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Show More</button></li>\n    <li><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"remove-button\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove</button></li>\n\n  </ul>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.favorite_players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2><small>Player: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.player_name : stack1), depth0))
	    + "</small></h2>\n\n<ul><data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n  <h3><small>Team: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.team_name : stack1), depth0))
	    + "</small></h3>\n  <h3><small>Sport: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.sport : stack1), depth0))
	    + "</small></h3>\n  <h3><small>Position: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.position : stack1), depth0))
	    + "</small></h3>\n  <h3><small>Player Number: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.player_number : stack1), depth0))
	    + "</small></h3><br>\n\n  <li><button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-button\" id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">Update</button></li>\n  <li><button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"remove-button\" id=\""
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showUpdateMyFavoritePlayerTemplate = __webpack_require__(38);
	...
	var onCreatePlayer = function onCreatePlayer(event) {
	  ...
	  var statusTextWhenCreateNewPlayer = 'All player info fields are required.  Please fill in all player info fields.';
	  ...
	  if (data.player_info.player_name[0] && data.player_info.team_name[0] && data.player_info.sport[0] && data.player_info.position[0] && data.player_info.player_number[0]) {
	    ...
	    var errorTextUponIncompletePlayerInfoFailure = 'All fields are required.  Please verify all player info fields are filled in.';
	...
	var onIndexPlayer = function onIndexPlayer(event) {
	  event.preventDefault();
	  // console.log('player/events.js (onIndexPlayer) ran!')

	  // Don't need to use data object here!
	  api.indexPlayer().then(ui.indexPlayerSuccess).catch(ui.indexPlayerFailure);
	};

	var onShowMorePlayer = function onShowMorePlayer(data) {
	  event.preventDefault();
	  // console.log('player/events.js (onShowMorePlayer) - (data is ', data)

	  api.showMorePlayer(data).then(ui.showMorePlayerSuccess).catch(ui.showMorePlayerFailure);
	};

	var onSaveUpdatedPlayer = function onSaveUpdatedPlayer(event) {
	  event.preventDefault();
	  ...
	  //  update player
	  if (data.player_info.team_name[0] && data.player_info.sport[0] && data.player_info.position[0] && data.player_info.player_number[0]) {
	    api.updatePlayer(store.favorite_player.id, data).then(ui.updatePlayerSuccess).catch(ui.updatePlayerFailure);
	  }
	};

	var onUpdatePlayer = function onUpdatePlayer(id) {
	  event.preventDefault();
	  ...
	  var showUpdateMyFavoritePlayerHtml = showUpdateMyFavoritePlayerTemplate({ favorite_player: store.favorite_player });
	...
	var onRemovePlayer = function onRemovePlayer(data) {
	  ...
	  api.removePlayer(data).then(ui.removePlayerSuccess).catch(ui.removePlayerFailure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onShowMorePlayer: onShowMorePlayer,
	  onUpdatePlayer: onUpdatePlayer,
	  onSaveUpdatedPlayer: onSaveUpdatedPlayer,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- Update Player input form -->\n<h2><small>Player: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.player_name : stack1), depth0))
	    + "</small></h2>\n<div data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"updateForm"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class='form-group updateDiv text-left'>\n  <form data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"updatePlayerForm\" class='text-left form-group updateForm'>\n    <input type=\"text\" name=\"player_info[team_name]\" id='update-player-team-name' value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.team_name : stack1), depth0))
	    + "\" placeholder=\"Team Name\"> Team Name<br>\n    <input type=\"text\" name=\"player_info[sport]\" id='update-player-sport' value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.sport : stack1), depth0))
	    + "\" placeholder=\"Sport\"> Sport<br>\n    <input type=\"text\" name=\"player_info[position]\" id='update-player-position' value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.position : stack1), depth0))
	    + "\" placeholder=\"Position\"> Position<br>\n    <input type=\"text\" name=\"player_info[player_number]\" id='update-player-player-number' value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.player_number : stack1), depth0))
	    + "\" placeholder=\"Player Number\"> Player Number<br>\n    <br>\n    <input type=\"submit\" id='save-id' data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.favorite_player : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-success save-update-button\" value='Update Player'>\n  </form>\n  <br>\n</div>\n";
	},"useData":true});
